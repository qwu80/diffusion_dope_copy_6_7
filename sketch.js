...
text("10\u00B9\u2070",(155-3)*s_x,(172+12+2)*s_y)


text("10\u00B9\u2070",(153-3)*s_x,(298+70+12+2)*s_y)
...
text("10\u00B9\u2074",(155-1)*s_x,(298+70-120)*s_y)
...
if (changg <122){
  text("10\u2077",(154)*s_x,(298+70+12+2)*s_y)
} 
if (changg ==122){
  //text("10\u2076",(155)*s_x,(172)*s_y)
  text("10\u2076",(154)*s_x,(298+70+12+2)*s_y)
...
text("10\u00B9\u00B3",(154-1)*s_x,(172+12+2)*s_y)

text("10\u00B9\u2074",(154-1)*s_x,(172-117+5)*s_y)
...
setDistance = (te) => {
  factor_ca = te
 distance_dis = (10-factor_ca*(d_factor))/2
}
